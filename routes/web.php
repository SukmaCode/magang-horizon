...
// Semua route dibungkus dengan prefix /internship
Route::prefix('internship')->group(function () {
    ...
    Route::get('/', function () {
        if (auth()->check()) {
            // Karena path ini sebelumnya mungkin hardcoded '/admin/dashboard',
            // kita gunakan ltrim agar menjadikannya '/internship/admin/dashboard'
            $path = ltrim(auth()->user()->role->dashboardPath(), '/');
            return redirect('/internship/' . $path);
        }
