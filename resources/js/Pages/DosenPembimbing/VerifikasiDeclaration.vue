<template>
    <AuthenticatedLayout>
        ...
        <div class="mb-8">
            ...
            <p class="text-sm font-jakarta text-text-secondary mt-1">Verifikasi dokumen pernyataan keaslian dari mahasiswa bimbingan Anda.</p>
        </div>
            ...
            <div class="xl:col-span-1">
                <CardContainer padding="p-0">
                    <div class="px-5 py-4 border-b border-gray-100">
                        ...
                        <p class="text-sm font-jakarta text-text-secondary mt-0.5">{{ declarations.length }} dokumen</p>
                    </div>
                    <div class="divide-y divide-gray-50 max-h-[600px] overflow-y-auto">
                        ...
                        >
                            <div class="flex items-center justify-between gap-2">
                                <div class="min-w-0">
                                    <p class="text-md font-jakartaSemiBold text-text-primary truncate">{{ decl.mahasiswa.nama_lengkap }}</p>
                                ...
                                >
                                    <span class="text-lg w-1 h-1 rounded-full" :class="getDotClass(decl.status)"></span>
                                    {{ decl.status_label }}
                                </span>
                            </div>
                        </button>
