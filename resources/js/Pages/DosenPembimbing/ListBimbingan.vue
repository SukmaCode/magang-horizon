<template>
    <AuthenticatedLayout>
        ...
        <div class="mb-8">
            <h1 class="text-xl font-bold text-text-primary font-jakarta">Mahasiswa Bimbingan</h1>
        ...
        <CardContainer class="mb-6">
            <div class="py-1 border-b border-gray-100 flex justify-between items-center mb-4">
                <h2 class="text-base font-bold text-text-primary font-jakarta">Daftar Bimbingan</h2>
            </div>
                ...
                <table class="w-full text-sm text-left">
                    <thead class="text-xs text-text-secondary uppercase bg-gray-50 border-b border-gray-200">
                        <tr>
                            ...
                            <th class="px-4 py-3 font-semibold">Perusahaan / Industri</th>
                            <th class="px-4 py-3 font-semibold text-center">SK Pembimbing</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-100">
                        <tr v-for="assignment in assignments" :key="assignment.id" class="hover:bg-gray-50/50 transition-colors">
                            <td class="px-4 py-3">
                                <p class="font-semibold text-text-primary">{{ assignment.magang_aktif.pendaftaran.mahasiswa.user.name }}</p>
                            </td>
                            <td class="px-4 py-3">
                            ...
                            <td class="px-4 py-3 text-center">
                                <a 
                                    ...
                                    target="_blank"
                                    class="inline-flex items-center gap-1 text-xs font-semibold text-primary bg-primary/10 hover:bg-primary/20 px-3 py-1.5 rounded-lg transition-colors">
