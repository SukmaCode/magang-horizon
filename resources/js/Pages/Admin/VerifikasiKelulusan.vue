<template>
    <AuthenticatedLayout>
        ...
        <div class="mb-8">
            ...
            <p class="text-sm font-jakarta text-text-secondary mt-1">Terbitkan sertifikat kelulusan resmi untuk mahasiswa yang telah disetujui Dosen Prodi.</p>
        </div>
            ...
            <div class="lg:col-span-2">
                <CardContainer class="overflow-hidden h-full">
                    ...
                    <div v-else class="p-12 text-center">
                        ...
                        <p class="text-sm font-jakarta text-text-secondary">Tidak ada mahasiswa yang menunggu penerbitan sertifikat saat ini.</p>
                    </div>
                </CardContainer>
            </div>
                    ...
                    <div class="">
                        <div v-if="sertifikats.length > 0" class="space-y-4">
                            <div v-for="cert in sertifikats" :key="cert.id" class="p-4 border border-gray-100 rounded-xl bg-gray-50/50 hover:bg-gray-50 transition-colors cursor-default">
                                ...
                                <p class="text-sm font-jakartaSemiBold text-text-primary pl-11">{{ cert.mahasiswa }}</p>
                            </div>
                        </div>
                        <div v-else class="text-center py-8 text-sm font-jakarta text-text-secondary">
