                    ...
                    <form @submit.prevent="submitApplication" class="py-6 space-y-6">
                        ...
                        <div v-if="!cvUploaded" class="mb-6 p-4 bg-danger/5 border border-danger/20 rounded-xl flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <Link :href="url('/mahasiswa/manajemen-cv')" class="mt-2 inline-block px-3 py-2 text-xs font-jakartaSemiBold text-white bg-danger rounded-md hover:bg-danger/90 transition-colors">
                                    Upload CV Sekarang
                                </Link>
                            </div>
                        </div>
                        <div v-else class="mb-6 p-4 bg-primary/5 border border-primary/20 rounded-xl flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <Link :href="url('/mahasiswa/manajemen-cv')" class="mt-2 inline-block text-xs font-jakartaSemiBold text-primary hover:underline">
                        ...
                        <div v-if="!linkedinFilled" class="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-xl flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <Link :href="url('/mahasiswa/profil')" class="mt-2 inline-block px-3 py-2 text-xs font-jakartaSemiBold text-white bg-amber-600 rounded-md hover:bg-amber-700 transition-colors">
...
function submitApplication() {
    form.post(url('/mahasiswa/kirim-cv'), {
        preserveScroll: true,
        onSuccess: () => {
