...
function submitBimbingan() {
    bimbinganForm.post(url('/mahasiswa/laporan-akhir/bimbingan'), {
        preserveScroll: true,
        onSuccess: () => {
...
function submitPdfForm() {
    pdfForm.post(url('/mahasiswa/laporan-akhir/generate-pdf'), {
        preserveScroll: true,
        onSuccess: () => {
...
function submitLaporan() {
    uploadForm.post(url('/mahasiswa/laporan-akhir'), {
        preserveScroll: true,
        forceFormData: true,
        onSuccess: () => {
