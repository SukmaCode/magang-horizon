    ...
    <AuthenticatedLayout>
        ...
        <template v-else>
            ...
            <div v-if="ev.can_download" class="flex justify-end">
                <a :href="`/mahasiswa-evaluation/${evaluationData.magang.id}/pdf`" class="inline-flex items-center gap-2 px-6 py-3 text-sm font-jakartaSemiBold text-white bg-primary rounded-md hover:bg-primary-hover transition-colors">
