<template>
    <AuthenticatedLayout>
        ...
        <!-- Back Button -->
        <div class="mb-6">
            <Link :href="url('/industri/seleksi-cv')" class="inline-flex items-center gap-2 text-sm font-jakartaSemiBold text-text-secondary hover:text-primary transition-colors">
