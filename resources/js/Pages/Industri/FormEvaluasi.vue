<template>
    <AuthenticatedLayout>
        ...
        <!-- Back Button -->
        <div class="mb-4">
            <Link href="/internship/industri/evaluasi" class="inline-flex font-jakartaSemiBold items-center gap-2 text-sm text-text-secondary hover:text-primary transition-colors">
