    ...
    <AuthenticatedLayout>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <CardContainer padding="p-6" class="border-l-4 border-l-accent">
                <h3 class="text-sm font-semibold text-text-secondary uppercase tracking-wider mb-2">Review CV Menunggu</h3>
                <p class="text-2xl font-bold text-text-primary font-jakarta">{{ pendingCount }}</p>
                <p class="text-xs text-text-secondary mt-2">Permohonan mahasiswa baru</p>
                <Link v-if="pendingCount > 0" href="/industri/seleksi-cv" class="inline-flex items-center gap-1 text-xs text-primary font-semibold mt-3 hover:text-primary-hover transition-colors">
                    Review Sekarang
            ...
            <CardContainer padding="p-6">
                <h3 class="text-sm font-semibold text-text-secondary uppercase tracking-wider mb-2">Peserta Aktif</h3>
            ...
            <CardContainer padding="p-6">
                <h3 class="text-sm font-semibold text-text-secondary uppercase tracking-wider mb-2">Persetujuan Absensi</h3>
                <p class="text-2xl font-bold font-jakarta" :class="pendingLogbooks > 0 ? 'text-accent' : 'text-success'">{{ pendingLogbooks }}</p>
                <p class="text-xs text-text-secondary mt-2">Menunggu konfirmasi Anda</p>
                <Link v-if="pendingLogbooks > 0" href="/industri/persetujuan-logbook" class="inline-flex items-center gap-1 text-xs text-primary font-semibold mt-3 hover:text-primary-hover transition-colors">
                    Review Logbook
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" /></svg>
                </Link>
            </CardContainer>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <Link href="/industri/seleksi-cv" class="flex flex-col items-center gap-2 p-4 bg-card rounded-xl border border-gray-100 hover:border-primary/30 hover:shadow-md transition-all duration-200 group">
                ...
                <span class="text-xs font-semibold text-text-primary">Seleksi CV</span>
            </Link>
            ...
            <Link href="/industri/agreement" class="flex flex-col items-center gap-2 p-4 bg-card rounded-xl border border-gray-100 hover:border-primary/30 hover:shadow-md transition-all duration-200 group">
                ...
                <span class="text-xs font-semibold text-text-primary">Agreement</span>
            </Link>
            ...
            <Link href="/industri/input-nilai" class="flex flex-col items-center gap-2 p-4 bg-card rounded-xl border border-gray-100 hover:border-primary/30 hover:shadow-md transition-all duration-200 group">
                ...
                <span class="text-xs font-semibold text-text-primary">Input Nilai</span>
            </Link>
        </div>
