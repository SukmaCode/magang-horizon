<template>
    <AuthenticatedLayout>
        ...
        <div class="mb-8">
            <h1 class="text-xl font-bold text-text-primary font-jakarta">Verifikasi Kelulusan</h1>
        ...
        <CardContainer class="overflow-hidden">
            <div class="px-6 py-5 border-b border-gray-100">
                <h2 class="text-base font-bold text-text-primary font-jakarta">Daftar Mahasiswa Siap Lulus</h2>
            </div>
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div class="flex-1">
                            ...
                            <div class="mt-4 grid grid-cols-3 gap-4 bg-gray-50/50 p-4 rounded-xl border border-gray-100 max-w-lg">
                                <div>
                                    <p class="text-[10px] uppercase font-bold text-text-secondary mb-1">Nilai Industri</p>
                                    <p class="text-lg font-bold text-text-primary font-jakarta">{{ magang.nilai_industri }}</p>
                                </div>
                                <div>
                                    <p class="text-[10px] uppercase font-bold text-text-secondary mb-1">Nilai Kampus</p>
                                    <p class="text-lg font-bold text-text-primary font-jakarta">{{ magang.nilai_kampus }}</p>
                                </div>
                                <div class="border-l border-gray-200 pl-4">
                                    <p class="text-[10px] uppercase font-bold text-text-secondary mb-1">Nilai Akhir</p>
                                    <p class="text-lg font-bold text-success font-jakarta">{{ magang.nilai_akhir }}</p>
                                </div>
                            </div>
                        </div>

                        <div class="shrink-0">
                            <button @click="openVerifyModal(magang)" class="inline-flex items-center gap-2 px-5 py-3 text-sm font-semibold text-white bg-success rounded-xl hover:bg-success/90 transition-colors shadow-sm">
            ...
            <div v-else class="p-12 text-center">
                ...
                <h3 class="text-base font-bold text-text-primary mb-1">Tidak Ada Data</h3>
            ...
            <div v-if="showVerifyModal" class="fixed inset-0 bg-gray-900/60 z-50 flex items-center justify-center p-4" @click.self="closeModal">
                <div class="bg-card rounded-2xl shadow-2xl w-full max-w-md">
                    <div class="px-6 py-5 border-b border-gray-100 flex justify-between items-center">
                        <h3 class="text-lg font-bold text-text-primary font-jakarta">Persetujuan Kelulusan</h3>
                    ...
                    <form @submit.prevent="submitVerify" class="p-6">
                        ...
                        <div class="flex gap-3 mt-6">
                            ...
                            <button type="submit" :disabled="verifyForm.processing" class="flex-1 px-4 py-2.5 text-sm font-semibold text-white bg-success rounded-xl hover:bg-success/90 flex justify-center items-center gap-2">
