...
class PerformanceEvaluationController extends Controller
{
    ...
    public function store(Request $request, MagangAktif $magangAktif)
    {
        ...
        $componentKeys = array_keys(PerformanceEvaluationScore::COMPONENTS);
     ...
     */
    private function authorizeEvaluation(Request $request, PerformanceEvaluation $evaluation): void
    {
