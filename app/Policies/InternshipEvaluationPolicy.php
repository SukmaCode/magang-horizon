...
class InternshipEvaluationPolicy
{
    /**
     ...
     */
    public function update(User $user, InternshipEvaluation $evaluation): bool
    {
     ...
     * - Dosen pembimbing supervising the magang
     */
    public function view(User $user, InternshipEvaluation $evaluation): bool
    {
     ...
     */
    public function download(User $user, InternshipEvaluation $evaluation): bool
    {
    ...
    {
        // For InternshipEvaluation, only Dosen Pembimbing (SUPERVISOR_1)
